...
1. <a href="../../Allfiles/Labs/06/az104-06-vms-template.json" download>⬇️ Download the ARM Template for Lab </a> also 
<a href="../../Allfiles/Labs/06/az104-06-vms-parameters.json" download>⬇️ Download the Parameters ARM Template for this Lab </a>
...
1. Locate and select the **ARM Template file** that you have downloaded and then select **Open**.

1. Select **Save**.

1. Select **Edit parameters** and load the **\Parameter file** that you have downloaded.
