...
1. <a href="../../Allfiles/Labs/11/az104-11-vm-template.json" download>⬇️ Download the ARM Template for Implement Monitoring Lab </a>
...
1. Locate and select the **az104-11-vm-template.json** file in your download directory and select **Open**.
